...
The rest of the whitepaper is organized as follows. In Section~\ref{sec-design} we provide high-level overview of \bc{} design.

\section{Design}
\label{sec-design}

Here we are going to provide high-level overview of \bc{} design. Technical details can be found in Section~\ref{sec-techdetails}. Section~\ref{sec-competition}
provides \bc{} with other known players in the same field. In Section~\ref{sec-team} we present a team which is working on \bc{}. In Section~\ref{sec-tokenomics}
