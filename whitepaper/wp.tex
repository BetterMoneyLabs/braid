...
Global transfer policies is efficient mechanism allowing to define a mechanism for controlling transfers for a token, such as:
\begin{itemize}
  \item rules for updating set of policies are set separately
